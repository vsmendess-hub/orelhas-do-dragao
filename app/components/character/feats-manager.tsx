...
export function FeatsManager({
  ...
  const saveFeats = async (newFeats: CharacterFeat[]) => {
    try {
      ...
      // Revalidar a página para atualizar a iniciativa em tempo real
      ...
      <div className="glass-card rounded-2xl p-6 space-y-4">
        ...
        {feats.length > 0 ? (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="flex gap-1">
                      <Button variant="ghost" size="sm" onClick={() => setViewingFeat(featDetails)}>
          ...
          <div className="glass-card-light rounded-lg border border-dashed border-purple-500/50 p-8 text-center">
            ...
            <p className="text-xs text-gray-400">Adicione feats obtidos em níveis ASI</p>
          </div>
        )}
              ...
              <div className="space-y-2">
                ...
                <div className="max-h-[400px] space-y-2 overflow-y-auto rounded-md border p-2">
                  {filteredFeats.length > 0 ? (
                      ...
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <p className="mt-1 text-sm text-gray-400">{feat.description}</p>
                          </div>
                    ...
                    <p className="py-8 text-center text-sm text-gray-400">Nenhum feat encontrado</p>
                  )}
                </div>
              </div>
